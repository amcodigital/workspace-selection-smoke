# Agent Instructions — workspace-selection-smoke
...
- Treat `.devcontainer/**` as Copier-owned; treat dependency files, agent settings, plugins, MCP configuration, and repository skills as repository-owned.
